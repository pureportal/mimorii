    ...
    <LegalPage title="Privacy policy">
      ...
      <LegalSection title="3. Processing in Mimorii">
        ...
        >
          ...
          <p>
            Agents report their name, hostname, operating system and version, agent version,
            capabilities, last-seen time, CPU and load, memory and swap use, process count, network
            byte totals, mounted-volume names and capacity, uptime, and recognized technology names.
            They do not send a complete process list or execute remote shell commands.
          </p>
          <p>
      ...
      <LegalSection title="7. Retention">
        <ul>
          ...
          <li>Host snapshots are kept for 90 days by default.</li>
          <li>
